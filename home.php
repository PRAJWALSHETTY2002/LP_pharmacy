      ...
      <div class=" navbar-inner">
        ...
        $select_sql = "SELECT  * FROM stock WHERE expire_date <= '$inc_date' and status='Available' ";
         $result =  mysqli_query($con,$select_sql); 
          ...
          <li><a href="product/view.php?invoice_number=<?php echo isset($_GET['invoice_number']) ? htmlspecialchars($_GET['invoice_number']) : ''; ?>"><span class="icon-th"></span> Products</a></li>
<li><a href="sales_report.php?invoice_number=<?php echo isset($_GET['invoice_number']) ? htmlspecialchars($_GET['invoice_number']) : ''; ?>"><span class="icon-bar-chart"></span> Sales Report</a></li>
<li><a href="backup.php?invoice_number=<?php echo isset($_GET['invoice_number']) ? htmlspecialchars($_GET['invoice_number']) : ''; ?>"><span class="icon-folder-open"></span> Backup</a></li>
...
?>
   ...
   <div class="container">
    ...
    <center>
      <div class="col-md-12">
      <form method="POST" action="insert_invoice.php<?php if (isset($_GET['invoice_number'])) { echo "?invoice_number=" . htmlspecialchars($_GET['invoice_number']); } ?>">
